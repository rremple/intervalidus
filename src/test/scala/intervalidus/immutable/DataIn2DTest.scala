...
class DataIn2DTest extends AnyFunSuite with Matchers with intervalidus.DataIn2DBaseBehaviors:
  ...
  test("Looking up data in intervals - bounded r1"):
    ...
    // still valid
    val fixture = mutable.DataIn2D(allData).toImmutable
  ...
  test("Adding and removing data in intervals - unbounded r1"):
    ...
    val fixture1 = fixture0.set("to", vertical2D(interval(5, 15)))
    ...
    val fixture2b = fixture2a.setIfNoConflict("Hey", vertical2D(intervalTo(-1))) match
      case Some(f) =>
        f.getAll.toList shouldBe ValidData2D("Hey", vertical2D(intervalTo(-1))) :: expectedData2
        f.setIfNoConflict("Hey", vertical2D(intervalTo(-1))) shouldBe None
        f
      case None => fail("unexpected conflict")

    val fixture3 = fixture2b
      .set("Hey", vertical2D(intervalTo(4)))
    ...
    val fixture4 = fixture3.set("World", vertical2D(intervalFrom(20)))
    ...
    val fixture6 = fixture5
      .set("remove me", DiscreteInterval2D(intervalFrom(day(1)), intervalFrom(1)))
      .remove(DiscreteInterval2D(intervalFrom(day(1)), intervalFrom(1)))
  ...
  test("Mapping, flatmapping, etc."):
    ...
    val fixture4 =
      fixture3.flatMap(d => DataIn2D.of[String, LocalDate, Int](d.value).map(x => ValidData2D(x.value, d.interval)))
  ...
  test("Updating data in intervals - unbounded r1"):
    ...
    val fixture1 = fixture0.update(ValidData2D("World!", vertical2D(interval(5, 7))))
    val expectedData1 = testData(
      ("Hello", unbounded, intervalTo(4)),
    ...
    val fixture2 = fixture1
      ...
      .update("to", vertical2D(interval(2, 9)))
    val expectedData2 = testData(
    ...
    val fixture3 = fixture2
      ...
      .update("World!", vertical2D(interval(-5, -2)))
    val expectedData3 = testData(
    ...
    val fixture4 = fixture3
      .set("update me", DiscreteInterval2D(intervalFrom(day(0)), intervalFrom(1)))
      .update("updated me", DiscreteInterval2D(intervalFrom(day(1)), intervalFrom(0)))
      .compressAll()
    val expectedData4 = testData(
      ("Hello", unbounded, intervalTo(-6)),
      ("World!", unbounded, interval(-5, -2)),
  ...
  test("All remove by interval - (1) simple + simple = simple"):
    ...
    val fixture1 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-14), day(14)), interval(4, 7)))
    val expectedData1 = testData()
    fixture1.getAll.toList shouldBe expectedData1

    val fixture2 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-15), day(15)), interval(3, 8)))
    val expectedData2 = testData()
    fixture2.getAll.toList shouldBe expectedData2
  ...
  test("All remove by interval - (2) simple + partial or partial + simple = edge (2)"):
    ...
    val fixture1 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(8), day(14)), interval(3, 8)))
    val expectedData1 = testData(
    ...
    val fixture2 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-15), day(-1)), interval(3, 8)))
    val expectedData2 = testData(
    ...
    val fixture3 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-15), day(15)), interval(6, 8)))
    val expectedData3 = testData(
    ...
    val fixture4 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-15), day(15)), interval(1, 5)))
    val expectedData4 = testData(
  ...
  test("All remove by interval - (3) simple + split or split + simple = slice (2)"):
    ...
    val fixture1 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-1), day(1)), interval(3, 8)))
    val expectedData1 = testData(
    ...
    val fixture2 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-15), day(15)), intervalAt(5)))
    val expectedData2 = testData(
  ...
  test("All remove by interval - (4) partial + partial = corner (1)"):
    ...
    // lower left
    val fixture1 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-15), day(-8)), interval(3, 5)))
    val expectedData1 = testData(
      ("World", interval(day(-14), day(14)), interval(6, 7)),
    ...
    // upper left
    val fixture2 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-15), day(-8)), interval(6, 8)))
    val expectedData2 = testData(
      ("World", interval(day(-14), day(14)), interval(4, 5)),
    ...
    // lower right
    val fixture3 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(8), day(15)), interval(3, 5)))
    val expectedData3 = testData(
    ...
    // upper right
    val fixture4 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(8), day(15)), interval(6, 8)))
    val expectedData4 = testData(
      ("World", interval(day(-14), day(14)), interval(4, 5)),
  ...
  test("All remove by interval - (5) partial + split or split + partial = bite (2)"):
    ...
    // bite left
    val fixture1 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-15), day(-8)), interval(5, 6)))
    val expectedData1 = testData(
      ("World", interval(day(-14), day(14)), intervalAt(4)),
    ...
    // bite right
    val fixture2 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(8), day(15)), interval(5, 6)))
    val expectedData2 = testData(
      ("World", interval(day(-14), day(14)), intervalAt(4)),
    ...
    // bite below
    val fixture3 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-6), day(6)), interval(3, 5)))
    ...
    // bite above
    val fixture4 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-6), day(6)), interval(6, 8)))
    val expectedData4 = testData(
      ("World", interval(day(-14), day(-7)), interval(4, 7)),
  ...
  test("All remove by interval - (6) split + split = hole (1)"):
    ...
    val fixture1 = DataIn2D(allData)
      .remove(DiscreteInterval2D(interval(day(-6), day(6)), interval(5, 6)))
    val expectedData1 = testData(
      ("World", interval(day(-14), day(14)), intervalAt(4)),
      ("World", interval(day(-14), day(-7)), interval(5, 6)),
      ("World", interval(day(-14), day(14)), intervalAt(7)),
  ...
  test("All update by interval - (1) simple + simple = simple"):
    ...
    val fixture1 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-14), day(14)), interval(4, 7)))
    val expectedData1 = testData(("update", interval(day(-14), day(14)), interval(4, 7)))
    fixture1.getAll.toList shouldBe expectedData1

    val fixture2 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-15), day(15)), interval(3, 8)))
  ...
  test("All update by interval - (2) simple + partial or partial + simple = edge (2)"):
    ...
    // partial + simple, to the right (remainder with common start)
    val fixture1 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(8), day(14)), interval(3, 8)))
    val expectedData1 = testData(
      ("World", interval(day(-14), day(7)), interval(4, 7)),
    ...
    // partial + simple, to the left (remainder does not have a common start)
    val fixture2 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-15), day(-1)), interval(3, 8)))
    val expectedData2 = testData(
    ...
    // simple + partial, above (remainder with common start)
    val fixture3 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-14), day(14)), interval(6, 8)))
    val expectedData3 = testData(
      ("World", interval(day(-14), day(14)), interval(4, 5)),
    ...
    // simple + partial, below (remainder does not have a common start)
    val fixture4 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-15), day(15)), interval(1, 5)))
    val expectedData4 = testData(
  ...
  test("All update by interval - (3) simple + split or split + simple = slice (2)"):
    ...
    // vertical slice, resulting in a left and right elements
    val fixture1 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-1), day(1)), interval(3, 8)))
    val expectedData1 = testData(
      ("World", interval(day(-14), day(-2)), interval(4, 7)),
    ...
    // horizontal slice, resulting in a lower and upper elements
    val fixture2 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-15), day(15)), intervalAt(5)))
    val expectedData2 = testData(
      ("World", interval(day(-14), day(14)), intervalAt(4)),
  ...
  test("All update by interval - (4) partial + partial = corner (1)"):
    ...
    // lower left
    val fixture1 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-15), day(-8)), interval(3, 5)))
    val expectedData1 = testData(
    ...
    // upper left
    val fixture2 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-15), day(-8)), interval(6, 8)))
    val expectedData2 = testData(
      ("World", interval(day(-14), day(14)), interval(4, 5)),
    ...
    // lower right
    val fixture3 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(8), day(15)), interval(3, 5)))
    val expectedData3 = testData(
      ("World", interval(day(-14), day(7)), interval(4, 5)),
      ("World", interval(day(-14), day(14)), interval(6, 7)),
    ...
    // upper right
    val fixture4 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(8), day(15)), interval(6, 8)))
    val expectedData4 = testData(
      ("World", interval(day(-14), day(14)), interval(4, 5)),
      ("World", interval(day(-14), day(7)), interval(6, 7)),
  ...
  test("All update by interval - (5) partial + split or split + partial = bite (2)"):
    ...
    // bite left
    val fixture1 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-15), day(-8)), interval(5, 6)))
    val expectedData1 = testData(
      ("World", interval(day(-14), day(14)), intervalAt(4)),
    ...
    // bite right
    val fixture2 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(8), day(15)), interval(5, 6)))
    val expectedData2 = testData(
      ("World", interval(day(-14), day(14)), intervalAt(4)),
      ("World", interval(day(-14), day(7)), interval(5, 6)),
      ("World", interval(day(-14), day(14)), intervalAt(7)),
    ...
    // bite below
    val fixture3 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-6), day(6)), interval(3, 5)))
    val expectedData3 = testData(
      ("World", interval(day(-14), day(-7)), interval(4, 7)),
    ...
    // bite above
    val fixture4 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-6), day(6)), interval(6, 8)))
    val expectedData4 = testData(
      ("World", interval(day(-14), day(-7)), interval(4, 7)),
      ("World", interval(day(-6), day(6)), interval(4, 5)),
  ...
  test("All update by interval - (6) split + split = hole (1)"):
    ...
    val fixture1 = DataIn2D(allData)
      .update("update", DiscreteInterval2D(interval(day(-6), day(6)), interval(5, 6)))
    val expectedData1 = testData(
      ("World", interval(day(-14), day(14)), intervalAt(4)),
      ("World", interval(day(-14), day(-7)), interval(5, 6)),
      ("World", interval(day(-14), day(14)), intervalAt(7)),
  ...
  test("Simple toString"):
    val fixturePadData = DataIn2D
      ...
      .set("W", DiscreteInterval2D(intervalFrom(day(0)), unbounded))
    ...
    val fixturePadLabel = DataIn2D
      ...
      .set("Wooooooorld", DiscreteInterval2D(intervalFrom(day(0)), unbounded))
