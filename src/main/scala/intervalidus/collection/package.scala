...
/**
  * Intervalidus's custom data structures for optimizing 1d, 2d, and 3d interval retrieval. Meant for internal use, but
  ...
  *     the subtrees of the data structure. Intervalildus uses the ordered hashes defined on the discrete domain
  ...
  *   - Multi-dictionaries (a.k.a., multi-maps) allow multiple values to be associated with the same key. Intervalidus
