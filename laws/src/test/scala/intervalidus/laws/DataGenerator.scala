...
import intervalidus.{DomainLike, DomainValueLike, Interval, immutable}
...
object DataGenerator:
  ...
  ): Gen[immutable.Data[String, D]] = for
  ...
  def genDim1(using DomainValueLike[Int]): Gen[immutable.Data[String, Dim1]] =
    gen(genNonIntersectingDim1)
  def genDim2(using DomainValueLike[Int]): Gen[immutable.Data[String, Dim2]] =
    gen(genNonIntersectingDim2)
  def genDim3(using DomainValueLike[Int]): Gen[immutable.Data[String, Dim3]] =
    gen(genNonIntersectingDim3)
  def genDim4(using DomainValueLike[Int]): Gen[immutable.Data[String, Dim4]] =
