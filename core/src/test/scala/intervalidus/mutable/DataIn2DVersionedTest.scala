...
class DataIn2DVersionedTest extends AnyFunSuite with Matchers with DataIn2DVersionedBaseBehaviors:
  ...
  def newDataIn2DVersioned(allData: Iterable[ValidData[String, IntDim]])(using
    CurrentInstant
  ): DataVersioned[String, IntDim] =
    val dataIn2DVersioned = DataVersioned.empty[String, IntDim]
  ...
  // shared
  testsFor(stringLookupTests("Mutable", newDataIn2DVersioned, DataVersioned(_), DataVersioned.ofValue(_)))
  ...
  test("Mutable: Adding and removing data in intervals"):
    ...
    fixture + ((intervalTo(4) x unbounded[Int]) -> "Hey")
    fixture - (intervalFrom(21) x unbounded[Int])
    fixture.incrementCurrentVersion()
    ...
    fixture7.fill(Interval.unbounded[IntDim] -> "Filled")
    ...
    val selfMerge = data1.copy
    selfMerge.merge(data1)
  ...
  test("Mutable: Mapping, flat mapping, etc."):
    ...
    val fixture2c = fixture.copy
    fixture2c.collectValues:
      case v if v.startsWith("H") => v + "?"
    fixture2c.getAll.toList shouldBe List(
      (intervalTo(5) x intervalFrom(0)) -> "Hey!?"
    )

    val fixture2d = fixture.copy
    val currentVersion = fixture2d.getCurrentVersion
    fixture2d.collectIntervals:
