...
class DataIn3DVersionedTest extends AnyFunSuite with Matchers with DataIn3DVersionedBaseBehaviors:
  ...
  def newDataIn3DVersioned(
    ...
    val dataIn3DVersioned = DataVersioned.empty[String, IntDim]
  ...
  // shared
  testsFor(stringLookupTests("Mutable", newDataIn3DVersioned, DataVersioned(_), DataVersioned.ofValue(_)))
