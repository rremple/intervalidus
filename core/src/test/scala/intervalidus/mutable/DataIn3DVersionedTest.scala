...
class DataIn3DVersionedTest extends AnyFunSuite with Matchers with DataIn3DVersionedBaseBehaviors:
  ...
  def newDataIn3DVersioned(
    ...
    val dataIn3DVersioned = DataIn3DVersioned[String, Int, Int, Int]()
  ...
  // shared
  testsFor(stringLookupTests("Mutable", newDataIn3DVersioned, DataIn3DVersioned(_), DataIn3DVersioned.of(_)))
  {
  ...
  test("Mutable: Adding and removing data in intervals"):
    val empty: DataIn3DVersioned[String, Int, Int, Int] = immutable.DataIn3DVersioned().toImmutable.toMutable
  ...
  test("Mutable: Mapping, flat mapping, etc."):
    ...
    fixture.flatMap(d => DataIn3DVersioned(Seq(d)))
    ...
    fixture.flatMap(d => DataIn3DVersioned.of[String, Int, Int, Int](d.value))
  ...
  test("Mutable: Compressing data in intervals"):
    ...
    val fixture1 = DataIn3DVersioned.from(allData)
    ...
    val fixture2 = DataIn3DVersioned.from(allData)
  ...
  test("Mutable: Updating data in intervals"):
    val one: DataIn3DVersioned[String, Int, Int, Int] = DataIn3DVersioned.of("value")
  ...
  test("Mutable: Approvals"):
    ...
    def timeboundVersionedString(
      ...
      val data = DataIn3DVersioned[String, LocalDate, LocalDate, Int]()
      allData.foreach: validData =>
