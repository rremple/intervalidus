...
class ContinuousValueTest extends AnyFunSuite:
  ...
  test("Ops on Int Domain"):
    ...
    assert(domain(3).orderedHashFixed == open(3).orderedHashFixed)
    assert(domain(0).orderedHashFixed <= open(4).orderedHashFixed)
    assert(bottom.orderedHashFixed <= open(4).orderedHashFixed)
    assert(domain(4).orderedHashFixed <= top.orderedHashFixed)
    assert(bottom.orderedHashFixed <= top.orderedHashFixed)
    assert(bottom.orderedHashFixed <= top.orderedHashFixed)

    assert(Domain.in1D(domain(4)) afterStart Domain.in1D(domain(3)))
    assert(Domain.in1D(open(4)) afterStart Domain.in1D(domain(4)))
    assert(!(Domain.in1D(domain(4)) afterStart Domain.in1D(domain(4))))
    assert(Domain.in1D(domain(4)) afterOrAtStart Domain.in1D(domain(4)))
    assert(Domain.in1D(domain(4)) beforeOrAtEnd Domain.in1D(domain(4)))
    assert(!(Domain.in1D(domain(4)) beforeEnd Domain.in1D(domain(4))))
    assert(Domain.in1D(open(4)) beforeEnd Domain.in1D(domain(4)))
    assert(Domain.in1D(domain(3)) beforeEnd Domain.in1D(domain(4)))

    assertResult("3")(Domain.in1D(open(3)).asString)
  ...
  test("Ops on Long Domain"):
    ...
    assert(pointClosed(3).orderedHashFixed == pointClosed(3).orderedHashFixed)
    assert(pointClosed(0).orderedHashFixed <= pointClosed(4).orderedHashFixed)
    assert(bottom.orderedHashFixed <= pointClosed(4).orderedHashFixed)
    assert(pointClosed(4).orderedHashFixed <= top.orderedHashFixed)
    assert(bottom.orderedHashFixed <= top.orderedHashFixed)
    assert(bottom.orderedHashFixed <= top.orderedHashFixed)
