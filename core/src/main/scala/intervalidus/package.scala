/**
  ...
  * intervals of arbitrary dimensions (tests cover one-, two-, three-, and four-dimensional data). It answers the
  * question "In what intervals are your data valid?"
  *
  ...
  *   - Foundational case classes, type classes, and enums for multidimensional domains, intervals, diff actions, and
  *     valid data.
