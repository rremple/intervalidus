...
object Domain:
  ...
  def in1D[R1: DomainValueLike](r1: Domain1D[R1]): In1D[R1] = r1 *: EmptyTuple
  def in2D[R1: DomainValueLike, R2: DomainValueLike](r1: Domain1D[R1], r2: Domain1D[R2]): In2D[R1, R2] = (r1, r2)
